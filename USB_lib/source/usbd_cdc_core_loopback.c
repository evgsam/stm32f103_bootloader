...
USBD_Class_cb_TypeDef USBD_CDC_cb = { usbd_cdc_Init, usbd_cdc_DeInit, usbd_cdc_Setup,
NULL, /* EP0_TxSent, */
usbd_cdc_EP0_RxReady, usbd_cdc_DataIn, usbd_cdc_DataOut,
NULL,
NULL,
NULL, USBD_cdc_GetCfgDesc,
#ifdef USE_USB_OTG_HS   
...
/*Configuration Descriptor*/
		...
		USB_CDC_CONFIG_DESC_SIZ,            // wTotalLength: общий размер всего дерева под данной конфигурацией в байтах
		0x00, 0x04,  						// bNumInterfaces: в конфигурации 4 интерфейса
		0x01, 								// bConfigurationValue:индекс данной конфигурации
		0x00, 								// iConfiguration:индекс строки, которая описывает эту конфигурацию
		0xC0,								// bmAttributes: self powered как будет питаться устройство
		...
		0x02, 								// bInterfaceClass:класс интерфеса - Communication Interface Class
		0x02, 								// bInterfaceSubClass: подкласс интерфейса: Abstract Control Model
		0x01, 								// nInterfaceProtocol: протокол интерфейса: Common AT commands
		...
		0x09, 								// bLength: размер дескриптора интерфейса
		USB_INTERFACE_DESCRIPTOR_TYPE, 		// bDescriptorType: тип дескриптора - интерфейс
		0x02,								// bInterfaceNumber:порядковый номер интерфейса - 2
		0x00, 								// bAlternateSetting: признак альтернативного интерфейса, у нас не используется
		0x01, 								// bNumEndpoints: количество эндпоинтов.
		0x02, 								// bInterfaceClass:класс интерфеса - Communication Interface Class
		0x02, 								// bInterfaceSubClass: подкласс интерфейса: Abstract Control Model
